...
{
    $.ajax({
        url:'http://cursovoi/api/session/CurrentUser.php',
        method:'get',
        dataType:'json',
        success: function(data)
        {
            ...
            $('.profile-btn').on('click',function()
            {
                ...
                $.ajax({
                    url:'http://cursovoi/api/entity/readRent.php',
                    method:'post',
                    dataType:'json',
                    data: {
                        'client':data.id
                ...
                $.ajax({
                    url:'http://cursovoi/api/entity/readBuy.php',
                    method:'post',
                    dataType:'json',
                    data: {
                        'client':data.id
            ...
            if(data.role == 'admin')
                {
                    $('.menu-list').append(`<li><button class='add-film'>добавить фильм</button></li>`);
                            ...
                            {
                                $.ajax({
                                    url:'http://cursovoi/api/session/exit.php',
                                    method:'post',
                                    dataType:'json',
                                    body: 'exit',
                            ...
                            $.ajax({
                                url:'http://cursovoi/api/entity/readFilms.php',
                                method:'get',
                                dataType: 'json',
                                success: function(response)
                                {
                                ...
                                $.ajax({
                                    url: 'http://cursovoi/api/entity/createFilm.php',
                                    method: 'post',
                                    contentType: false,
                                    processData: false,
                                    data: formData,
                                        ...
                                        location.reload(true);
                                            ...
                                            $(`#rent${i}`).on('click',function()
                                            {
                                                ...
                                                $('#rent-form').on('submit',function()
                                                {
                                                    ...
                                                    $.ajax({
                                                        url:'http://cursovoi/api/entity/rentFilm.php',
                                                        method:'post',
                                                        dataType:'json',
                                                        data:rentBody,
                                                        success:function(message)
                                            ...
                                            $(`#buy${i}`).on('click',function()
                                            {
                                                ...
                                                $('.buy-btn').on('click',function()
                                                {
                                                    ...
                                                    $.ajax({
                                                        url:'http://cursovoi/api/entity/buyFilm.php',
                                                        method:'post',
                                                        dataType: 'json',
                                                        data: buyBody,
                                                        success: function(message)
                                            ...
                                            $.ajax({
                                                url: 'http://cursovoi/api/entity/updateFilm.php',
                                                method: 'post',
                                                contentType: false,
                                                processData: false,
                                                data: formData,
                                            ...
                                            {
                                                $.ajax({
                                                    url: 'http://cursovoi/api/entity/deleteFilm.php',
                                                    method: 'post',
                                                    dataType: 'json',
                                                    data: {
                                                        'id':film.id
